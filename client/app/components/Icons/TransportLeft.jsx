    ...
    return (
      <svg width={`${width}px`} height={`${height}px`} viewBox="0 0 31 23" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g transform="translate(-486.000000, -1844.000000)">
            <g id="Group-19" transform="translate(185.000000, 1756.000000)">
              <g id="ic_description_transport_left" transform="translate(316.000000, 99.000000) scale(-1, 1) translate(-316.000000, -99.000000) translate(298.000000, 81.000000)">
