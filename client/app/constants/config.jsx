...
export const SHAREAPP_TERM = 'https://www.shareapp.com.tw/terms';
export const SHAREAPP_FACEBOOK = 'https://www.facebook.com/ShareAppall/?fref=ts';
export const SHAREAPP_LINEAPP = 'https://line.me/R/ti/p/@shareapp';
export const SHAREAPP_APPLESTORE = 'https://goo.gl/zNc9vl';
export const SHAREAPP_GOOGLESTORE = 'https://goo.gl/eDYXMT';
