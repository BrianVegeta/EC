...
= userprofile =
===============================================>>>>>*/
const ACTION_PREFIX = 'USERPROFILE.ITEMS';
const REDUCER_KEY = 'userprofileItems';
const SIZE = 9;
 ...
 */
export function fetchItems(categoryID, uid, recursiveRecords = []) {
  return (dispatch, getState) => {
    const {
      size,
      index,
