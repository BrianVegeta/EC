...
var DayPicker = function (_React$Component) {
  ...
  _createClass(DayPicker, [{
    ...
    value: function () {
      function renderNavigation() {
        ...
        var _props3 = this.props,
            hiddenChangeMonthButton = _props3.hiddenChangeMonthButton,
    ...
    value: function () {
      function renderWeekHeader(index, language) {
